...
| **[MD](https://github.com/doocs/md)** | v2.0.1 | 微信 Markdown 编辑器,Markdown 文档自动即时渲染为微信图文 |
| **[Karakeep](https://github.com/hoarder-app/hoarder)** | v0.24.1 | 原名Hoarder，一个自托管的全能书签管理工具，支持保存链接、笔记和图片，具有AI自动标签功能。 |
